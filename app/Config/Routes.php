...
$routes->get('/', '\App\Controllers\WebController::index');
$routes->get('login', '\App\Controllers\WebController::login');
$routes->get('dashboard', '\App\Controllers\WebController::dashboard');
$routes->get('orders', '\App\Controllers\WebController::orders');
$routes->get('tables', '\App\Controllers\WebController::tables');
$routes->get('menu-items', '\App\Controllers\WebController::menuItems');
$routes->get('reports', '\App\Controllers\WebController::reports');
$routes->get('users', '\App\Controllers\WebController::users');
